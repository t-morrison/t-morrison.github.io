...
library(maptools)
library(ggmap)
#rmarkdown::render("blogCrime.Rmd")
```
...
ggmap(mapImage) +
  ...
  geom_point(data=guns[arrest=="true"], aes(x=longitude, y=latitude), col="black", size=.1, fill=NA, alpha=.3) +
  ...
  ggtitle("Weapons related arrests, 2001-2016") + xlab("") + ylab("")
#6
```
